...
FQ1=/private/groups/carpenterlab/emalekos/RNAZoo_meta/RNAZoo/experiments/riboseq_signal_model/data/external/chothani_rna/fastq/${SRR}_1.fastq.gz
FQ2=/private/groups/carpenterlab/emalekos/RNAZoo_meta/RNAZoo/experiments/riboseq_signal_model/data/external/chothani_rna/fastq/${SRR}_2.fastq.gz
